...
INSERT INTO "new_day_habits" ("created_at", "day_id", "habit_id", "id") SELECT "created_at", "day_id", "habit_id", "id" FROM "day_habits";
...
INSERT INTO "new_habit_week_days" ("created_at", "habit_id", "id", "week_day") SELECT "created_at", "habit_id", "id", "week_day" FROM "habit_week_days";
