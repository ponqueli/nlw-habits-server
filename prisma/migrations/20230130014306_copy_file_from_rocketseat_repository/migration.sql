/*
  ...
  - You are about to drop the column `created_at` on the `day_habits` table. All the data in the column will be lost.
  - You are about to drop the column `created_at` on the `habit_week_days` table. All the data in the column will be lost.
